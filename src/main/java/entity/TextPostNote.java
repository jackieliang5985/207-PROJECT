...
public class TextPostNote extends PostNote {
    ...
    public TextPostNote(int x, int y, int width, int height, Color color, NotePanel panel) {
    ...
    public void draw(Graphics g) {
        // draws the label and the text field, this is called in the NotePanel class
